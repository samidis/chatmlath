...
#users .uzr.sami1 img.fl.u-ico {
    
     margin-left: 5px;
      
    }

#users .uzr.sami1 img.fl.ustat {
      width: 0px !important;
...
#users .uzr.sami1 .fitimg.fl.u-pic {
...
#users .uzr.sami1 .fl.dots {
  padding-right: 0px !important;
}

#users .uzr.sami1 .u-topic.fl {
-webkit-text-fill-color: transparent;
  margin-left: 5px;
}
...
var l_itvsami=setInterval(function(){
    if(myid!=null){
        ...
        $("#users .uzr.sami1 .fitimg.fl.u-pic").append('<img class="sami_star1" src="https://up6.cc/2023/05/168484951831041.png">');
		$("#users .uzr.sami1 span.u-topic.fl").after('<img id="mystory1" class="My_vedio1" title="فيديو" style="float: right;width: 20px;margin-top: 0px;margin-right: 5px;cursor: pointer;" src="https://up6.cc/2023/05/168484951889833.gif">');
        $("#users .uzr.sami1 span.usid.fr, #users .uzr.sami1 img.co").hide(); 
